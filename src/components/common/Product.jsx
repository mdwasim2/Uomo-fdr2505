      ...
      <div className="flex justify-between">
        <div>
          ...
          <div className="flex gap-2.5">
            {item.discountprice && (
              <del className="font-jost text-primary-black text-base font-normal">
                ${item.discountprice}
              </del>
            )}
            <h4
              className={`font-jost text-base font-normal ${item.discountprice ? "text-redcolor " : "text-primary-black"}`}
            >
              ${item.price}
            </h4>
          </div>
